...
return new class extends Migration
{
    private array $descriptions = [
        ...
        'regex_bdv' => 'Regex para extraer datos de notificaciones SMS del Banco de Venezuela (BDV). Debe incluir grupos nombrados: amount, phone, reference, date, time.',
        'regex_bnc' => 'Regex para extraer datos de notificaciones SMS del Banco Nacional de Crédito (BNC). Debe incluir grupos nombrados: amount, phone, reference, date, time.',
    ];
